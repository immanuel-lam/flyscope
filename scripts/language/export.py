...
def main():
    model=CircuitLM();checkpoint=DATA/'real/chat.safetensors';model.load_weights(str(checkpoint if checkpoint.exists() else DATA/'real/weights.safetensors'));mx.eval(model.parameters())
