...
2. Train a small local MLX chat/language model through real MaleCNS directed pathways. Save checkpoint, tokenizer, IDs, data provenance, held-out evaluation and graph-ablation results. Integrate chat and actual neural state display. In progress.
