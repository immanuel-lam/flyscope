...
| more relevant, less repetitive conversation | retained four-channel, short-context and persistent-prompt evaluation failures; source-edge attention experiment | **open**; small graph and ordinary attention candidates rejected; all completed foundation candidates rejected; balanced-context training with a larger offline reference is active; no useful replacement verified |
